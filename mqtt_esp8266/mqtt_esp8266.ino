...
const char* version_id = "1.0"; 
const char* ssid = "rzeszow";
const char* password = "1wlan2!rzeszow?";
const char* mqtt_server = "192.168.20.125";

#define ADD 1
// Set this node's subscribe and publish topic prefix
#define MY_MQTT_PUBLISH_TOPIC_PREFIX "socket##ADD##-out"
#define MY_MQTT_SUBSCRIBE_TOPIC_PREFIX "socket##ADD##-in"

// Set MQTT client id
#define MY_MQTT_CLIENT_ID "socket##ADD"
